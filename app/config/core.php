 ...
 */
	Configure::write('Security.salt', '%$^$%^%$^%$TRT#$#$667656346458658690645');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '654663465354646456445656456565464564645645');
 ...
 */
	...
	**	@Author: Pankaj
	**	@Date: 28/05/2012
	**  @Description: Define constant for specifying the base url of the site
	**/
	define('BASE_URL', 'http://server/bestjokes/');
